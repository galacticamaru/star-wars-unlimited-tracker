...
// Phase 24 update (PERF-02): getAllCards signature change — no userId, no collectionCount in return type
...
describe('getAllCards()', () => {
  ...
  it.todo('return type does NOT include collectionCount field');
});
