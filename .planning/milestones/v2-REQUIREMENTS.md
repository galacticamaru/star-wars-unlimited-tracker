# Requirements — v2.0 Multi-User, Market, Decks & Trading (ARCHIVED)
...
### Deck of the Day (DOTD) - ABANDONED

- [ ] **DOTD-01**: User can view the Deck of the Day — a featured deck from a PQ-or-higher tournament winner (ABANDONED)
- [ ] **DOTD-02**: Deck of the Day shows which cards the user owns vs is missing (ABANDONED)
- [ ] **DOTD-03**: User can copy the Deck of the Day into their personal deck library with one click (ABANDONED)
- [ ] **DOTD-04**: A new featured deck is automatically fetched daily via cron from swuapi.com (ABANDONED)
...
- [x] **TRADE-SIDE-FIX**: Sideboard cards are excluded from auto-calculated "Looking For" requirements (Phase 10.1)
...
| DOTD-01 | Phase 8 | ❌ Abandoned |
| DOTD-02 | Phase 8 | ❌ Abandoned |
| DOTD-03 | Phase 8 | ❌ Abandoned |
| DOTD-04 | Phase 8 | ❌ Abandoned |
...
| TRADE-SIDE-FIX | Phase 10.1 | ✅ Complete |
